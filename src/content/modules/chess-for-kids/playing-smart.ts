...
export const playingSmart: Lesson = {
  ...
  activities: [
    ...
    },
    {
      ...
      options: [
        "Just move as fast as you possibly can and quietly hope it works out.",
        "Is anything attacked? Is my move safe? Am I giving a piece away?",
        "Only ever look at your very own king and nothing else at all.",
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
        "Just play it instantly and quickly without another single thought.",
        "Double-check: does my move leave a piece to be taken for free?",
        "Close your eyes and move absolutely any piece on the whole board.",
      ],
      correctIndex: 1,
