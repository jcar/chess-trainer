...
export const goodFirstMoves: Lesson = {
  ...
  activities: [
    ...
    },
    {
      ...
      options: [
        "Yes — she's the strongest, so attack with her right away!",
        "No — they'll chase her around, get pieces out for free.",
        "Yes, send her out on the very first move only.",
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
        "It wins a free enemy pawn right away in the opening.",
        "It hides the king safe AND sends a rook to the middle.",
        "It lets your brave king march out into the open and attack.",
      ],
      correctIndex: 1,
