...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: "piece-scholar",
    title: "Piece Scholar",
    description: "Met all six chess pieces.",
    emoji: "🎓",
    earned: ({ data }) =>
      allDone(data, [
        "meet-the-rook",
  ...
  },
  {
    ...
    description: "Delivered your very first checkmate!",
    emoji: "♚",
    earned: ({ data }) =>
  ...
  },
  {
    ...
    description: "Learned to check before you move.",
    emoji: "🛡️",
  ...
  },
  {
    id: "fork-master",
    title: "Fork Master",
    description: "Won a piece with a fork.",
    emoji: "🍴",
  ...
  },
  {
    id: "skewer-star",
    title: "Skewer Star",
    description: "Won the queen with a skewer.",
    emoji: "🍢",
  ...
  },
  {
    id: "promoter",
    title: "Pawn to Queen",
    description: "Marched a pawn home and made a queen.",
    emoji: "👑",
  ...
  },
  {
    ...
    description: "Beat one of Pip's Challenges.",
    emoji: "🏅",
    earned: ({ data }) =>
  ...
  {
    id: "crowned",
    title: "Pip's Champion",
    description: "Finished the whole quest — you're a chess player!",
    emoji: "🏆",
